...
M5AtomGps::M5AtomGps(M5AtomGpsSettings& m5AtomGpsSettings, IOTGpsPublishInterface& gpsInterface) : ESP32Gps(m5AtomGpsSettings, gpsInterface) {
	this->m5AtomGpsSettings = &m5AtomGpsSettings;
	this->ledOnTimeStamp = 0;
	this->ledOn = false;
}

void M5AtomGps::begin(){
