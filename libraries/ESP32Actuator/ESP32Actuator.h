...
struct BinaryGPIOSetting {
	BinaryPropertyActuated propertyActuated;
	ESP32_GPIO_NUM gpio;
} ;

struct AnalogGPIOSetting {
...
public:
	ESP32Actuator(ESP32ActuatorSettings& esp32ActuatorSettings, IOTActuatorPublishInterface& actuatorInterface);
	void addGPIOSetting(BinaryGPIOSetting gpioSetting);
	void addGPIOSetting(AnalogGPIOSetting gpioSetting);
	void deepSleep();
...
private:
	static bool getBinaryValueCallback(BinaryPropertyActuated propertyActuated);
	static String getAnalogValueCallback(AnalogPropertyActuated propertyActuated);
	static void setBinaryValueCallback(BinaryPropertyActuated propertyActuated, bool value);
	static void setAnalogValueCallback(AnalogPropertyActuated propertyActuated, String value);
	static BinaryGPIOSetting getGpioSetting(BinaryPropertyActuated propertyActuated);
	static AnalogGPIOSetting getGpioSetting(AnalogPropertyActuated propertyActuated);
